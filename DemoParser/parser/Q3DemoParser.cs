    ...
    class Q3DemoParser
    {
        ...
        */
        ...
        public RawInfo parseConfig()
        {
            ...
            RawInfo info = new RawInfo(file_name, msgParser.clc, msgParser.client.clientEvents, msgParser.client.maxSpeed, msgParser.sequenceServerTimeStart, msgParser.sequenceServerTimeEnd);
            return info;
        }
